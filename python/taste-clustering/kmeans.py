...
scaled_features_df = scaled_features_df.drop(
    ['loudness', 'key', 'time_signature', 'mode'], axis=1)
...
print("Print top genres and artists of each cluster...")
for i in range(k):
    print("{}\n- {}\n".format("/".join(listLimit(2, genre_groups[i])),
